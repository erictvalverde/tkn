...
<?php } //foreach ($options as $value)
	...
	$tknoptions = array();	
	$tknoptions[] = array(	"name" => "Imagem do Header", "type" => "heading");
	$tknoptions[] = array(	"name" => "Imagem Header","desc" => "Endere&ccedil;o da imagem para o Header (Copiar url quando fizer o upload da imagem)","id" => $shortname."_header_img","std" => "","type" => "text");
